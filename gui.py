...
Button(main, text="QUIT", command=main.destroy).grid(row=11, column=2, sticky=W, pady=4,padx=3)    
Button(main, text="ALGORITHMS", command=open_algo).grid(row=8, column=0, sticky=W, pady=4,padx=3)
Button(main, text="Clear", command=clear).grid(row=8, column=2, sticky=W, pady=4,padx=3)
...
#Button(main, text="KNN",command=knn_prediction).grid(row=8, column=6, sticky=W, pady=4,padx=3)
#Button(main, text="Naive Bayes",command=naive_prediction).grid(row=12, column=6, sticky=W, pady=4,padx=3)
Button(main, text="BACK",command=method2).grid(row=20, column=2, sticky=W, pady=4,padx=3)
#Button(main, text="PREDICTION OF UNIVERSITY",command=first).grid(row=13, column=6, sticky=W, pady=4,padx=4)
#Button(main, text="NEXT",command=method3).grid(row=19, column=2, sticky=W, pady=4,padx=3)
